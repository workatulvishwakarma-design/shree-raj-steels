...
export async function generateMetadata({ params }: { params: Promise<{ slug: string; subSlug: string }> }) {
  ...
  return {
    ...
    openGraph: {
      title: subProduct.seoTitle,
      description: subProduct.seoDescription,
      url: `https://www.shreerajsteels.com/products/${slug}/${subSlug}`,
      images: [
        {
          url: `https://www.shreerajsteels.com${subProduct.heroImage || subProduct.image}`,
          width: 800,
          height: 600,
          alt: subProduct.alt || subProduct.name,
        },
      ],
    },
  };
