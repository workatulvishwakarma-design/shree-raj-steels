...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const category = Object.values(PRODUCT_CATEGORIES).find((item) => item.slug === slug);
  ...
  return {
    title: `${category.title} Manufacturer, Stockist & Supplier | Shree Raj Steels`,
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mt-8 items-center">
            ...
            <div className="relative">
              <div className="aspect-[4/3] relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-navy-950/20">
                <Image 
